            ...
            <div className='relative'>
                <div className='relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]'>
                    <div className='absolute top-0 left-0 w-full h-full pointer-events-none md:w-3/5 xl:w-auto'>
                        <img className='w-full h-full object-cover md:object-right' alt='smartest AI' height={730} width={800} src={service1}/>
                    </div>
                        ...
                        <ul className='body-2'>
                            {brainwaveServices.map((item, index)=>(
                                <li className="flex items-start py-4 border-t border-n-6" key={index}>
                                    <img className='mr-4' width={24} height={24} src={check}/>
                                    <p>{item}</p>
                                </li>
                            ))}
                        </ul>
                ...
                <div className='relative z-1 grid gap-5 lg:grid-cols-2'>
                    <div className='relative min-h-[39rem] border border-n-1/10 rounded-3xl overflow-hidden'>
                        ...
                        <div className='absolute inset-0 flex flex-col justify-end p-8 bg-gradient-to-b from-n-8/0 to-n-8/90 lg:p-15'>
                            ...
                            <p className='body-2 mb-[3rem] text-n-3'>Automatically enhance your photos using our app&apos;s photo editing feature. Try it now!</p>
                        </div>
                    ...
                    <div className='p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]'>
                        ...
                        <div className='relative h-[20rem] bg-n-8 rounded-xl overflow-hidden md:h-[25rem]'>
                            <img className='w-full h-full object-cover ' src={service3} width={520} height={400} alt='scary robot'/>
                            <VideoChatMessage/>
                            <VideoBar/>
                        </div>
                    </div>
